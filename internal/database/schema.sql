...
CREATE TABLE IF NOT EXISTS bus_service (
    ...
    am_peak_freq VARCHAR(10) NOT NULL,
    am_offpeak_freq VARCHAR(10) NOT NULL,
    pm_peak_freq VARCHAR(10) NOT NULL,
    pm_offpeak_freq VARCHAR(10) NOT NULL,
    ...
    CONSTRAINT fk_destination_stop
        ...
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    CONSTRAINT uq_bus_service_service_direction UNIQUE (service_number, direction)
);
